...
export default function Intro() {
    ...
    return (
        <div className="relative min-h-screen flex flex-col text-center justify-center gap-4">
            ...
            <motion.div 
              ...
              className="text-3xl flex justify-center gap-16 py-3 mb-4 text-gray-600 md:text-4xl lg:text-6xl dark:text-gray-300">
            ...
            <div className='down-anim s-down-anim dark:text-white'>
                <FaAngleDown className='dwnicn' />
                <FaAngleDown className='dwnicn' />
                <FaAngleDown className='dwnicn' />
            </div>
